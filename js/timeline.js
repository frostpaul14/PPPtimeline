...
(() => {
    var t = {
            856: function(t) {
                t.exports = function() {
                    ...
                    var c, u = k(Array.prototype.forEach),
                        m = k(Array.prototype.pop),
                        _ = k(Array.prototype.push),
                    ...
                    function M(t, e) {
                        for (; null !== t;) {
                            ...
                            if (i) {
                                ...
                                if ("function" == typeof i.value) return k(i.value)
                            }
                            t = a(t)
                        }
                        return function(t) {
                    ...
                    var E = n(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink", "blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "content", "data", "datalist", "dd", "decorator", "del", "details", "dfn", "dialog", "dir", "div", "dl", "dt", "element", "em", "fieldset", "figcaption", "figure", "font", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "map", "mark", "marquee", "menu", "menuitem", "meter", "nav", "nobr", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "section", "select", "shadow", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"]),
                        L = n(["svg", "a", "altglyph", "altglyphdef", "altglyphitem", "animatecolor", "animatemotion", "animatetransform", "circle", "clippath", "defs", "desc", "ellipse", "filter", "font", "g", "glyph", "glyphref", "hkern", "image", "line", "lineargradient", "marker", "mask", "metadata", "mpath", "path", "pattern", "polygon", "polyline", "radialgradient", "rect", "stop", "style", "switch", "symbol", "text", "textpath", "title", "tref", "tspan", "view", "vkern"]),
                        ...
                        A = n(["math", "menclose", "merror", "mfenced", "mfrac", "mglyph", "mi", "mlabeledtr", "mmultiscripts", "mn", "mo", "mover", "mpadded", "mphantom", "mroot", "mrow", "ms", "mspace", "msqrt", "mstyle", "msub", "msup", "msubsup", "mtable", "mtd", "mtext", "mtr", "munder", "munderover"]),
                        N = n(["maction", "maligngroup", "malignmark", "mlongdiv", "mscarries", "mscarry", "msgroup", "mstack", "msline", "msrow", "semantics", "annotation", "annotation-xml", "mprescripts", "none"]),
                        I = n(["#text"]),
                        C = n(["accept", "action", "align", "alt", "autocapitalize", "autocomplete", "autopictureinpicture", "autoplay", "background", "bgcolor", "border", "capture", "cellpadding", "cellspacing", "checked", "cite", "class", "clear", "color", "cols", "colspan", "controls", "controlslist", "coords", "crossorigin", "datetime", "decoding", "default", "dir", "disabled", "disablepictureinpicture", "disableremoteplayback", "download", "draggable", "enctype", "enterkeyhint", "face", "for", "headers", "height", "hidden", "high", "href", "hreflang", "id", "inputmode", "integrity", "ismap", "kind", "label", "lang", "list", "loading", "loop", "low", "max", "maxlength", "media", "method", "min", "minlength", "multiple", "muted", "name", "noshade", "novalidate", "nowrap", "open", "optimum", "pattern", "placeholder", "playsinline", "poster", "preload", "pubdate", "radiogroup", "readonly", "rel", "required", "rev", "reversed", "role", "rows", "rowspan", "spellcheck", "scope", "selected", "shape", "size", "sizes", "span", "srclang", "start", "src", "srcset", "step", "style", "summary", "tabindex", "title", "translate", "type", "usemap", "valign", "value", "width", "xmlns"]),
                        ...
                        R = n(["xlink:href", "xml:id", "xlink:title", "xml:space", "xmlns:xlink"]),
                        z = o(/\{\{[\s\S]*|[\s\S]*\}\}/gm),
                        P = o(/<%[\s\S]*|[\s\S]*%>/gm),
                        H = o(/^data-[\-\w.\u00B7-\uFFFF]/),
                        q = o(/^aria-[\-\w]+$/),
                    ...
                    var Z = function() {
                        ...
                        G = function(t, e) {
                            ...
                            e.currentScript && e.currentScript.hasAttribute(a) && (i = e.currentScript.getAttribute(a));
                            var s = "dompurify" + (i ? "#" + i : "");
                            try {
                    ...
                    return function t() {
                        ...
                        var a = e.document,
                            ...
                            d = e.NodeFilter,
                            c = e.NamedNodeMap,
                            k = void 0 === c ? e.NamedNodeMap || e.MozNamedAttrMap : c,
                            Y = e.Text,
                            V = e.Comment,
                            J = e.DOMParser,
                            X = e.trustedTypes,
                        ...
                        var _t = z,
                            ...
                            bt = F,
                            wt = null,
                            kt = x({}, [].concat(W(E), W(L), W(D), W(A), W(I))),
                            xt = null,
                            Tt = x({}, [].concat(W(C), W(j), W(O), W(R))),
                            Mt = null,
                            Et = null,
                            Lt = !0,
                            Dt = !0,
                        ...
                        var te = "http://www.w3.org/1998/Math/MathML",
                            ...
                            ae = function(t) {
                                ...
                                if (t.namespaceURI === ie) {
                                    ...
                                    var s = x({}, ["title", "style", "font", "a", "script"]);
                            ...
                            ne = function(t, e) {
                                ...
                                if (e.removeAttribute(t), "is" === t && !xt[t])
                                    if (jt || Ot) try {
                                        se(e)
                                    } catch (t) {} else try {
                                        e.setAttribute(t, "")
                            ...
                            oe = function(t) {
                                ...
                                return t && i && e.body.insertBefore(s.createTextNode(i), e.body.childNodes[0] || null), ht.call(e, Nt ? "html" : "body")[0]
                            },
                            re = function(t) {
                            ...
                            le = function(t) {
                                return !(t instanceof Y || t instanceof V || "string" == typeof t.nodeName && "string" == typeof t.textContent && "function" == typeof t.removeChild && t.attributes instanceof k && "function" == typeof t.removeAttribute && "function" == typeof t.setAttribute && "string" == typeof t.namespaceURI && "function" == typeof t.insertBefore)
                            },
                            he = function(t) {
                            ...
                            ce = function(t) {
                                ...
                                if (de("uponSanitizeElement", t, {
                                        tagName: a,
                                        allowedTags: wt
                                    }), !he(t.firstElementChild) && (!he(t.content) || !he(t.content.firstElementChild)) && b(/<[/\w]/g, t.innerHTML) && b(/<[/\w]/g, t.textContent)) return se(t), !0;
                                if (!wt[a] || Mt[a]) {
                                    if (Ht && !$t[a]) {
                                        var s = it(t),
                                            n = et(t);
                                ...
                                return t instanceof h && !ae(t) ? (se(t), !0) : "noscript" !== a && "noembed" !== a || !b(/<\/no(script|embed)/i, t.innerHTML) ? (At && 3 === t.nodeType && (e = t.textContent, e = g(e, _t, " "), e = g(e, pt, " "), t.textContent !== e && (_(i.removed, {
                                    element: t.cloneNode()
                                ...
                                if (o) {
                                    ...
                                    for (n = o.length; n--;) {
                                        var l = e = o[n],
                                            h = l.name,
                                            d = l.namespaceURI;
                                        if (a = y(e.value), s = p(h), r.attrName = s, r.attrValue = a, r.keepAttr = !0, r.forceKeepAttr = void 0, de("uponSanitizeAttribute", t, r), a = r.attrValue, !r.forceKeepAttr && (ne(h, t), r.keepAttr))
                                            if (b(/\/>/i, a)) ne(h, t);
                                            else {
                                                At && (a = g(a, _t, " "), a = g(a, pt, " "));
                        ...
                        return i.sanitize = function(t, s) {
                            ...
                            if (t || (t = "\x3c!--\x3e"), "string" != typeof t && !he(t)) {
                                if ("function" != typeof t.toString) throw w("toString is not a function");
                                if ("string" != typeof(t = t.toString())) throw w("dirty is not a string, aborting")
                            }
                            if (!i.isSupported) {
                            ...
                            if (It || Vt(s), i.removed = [], "string" == typeof t && (qt = !1), qt);
                                ...
                                if (!jt && !At && !Nt && -1 === t.indexOf("<")) return st && zt ? st.createHTML(t) : t;
                                if (!(n = oe(t))) return jt ? null : nt
                            }
                            n && Ct && se(n.firstChild);
                            for (var u = re(qt ? t : n); h = u.nextNode();) 3 === h.nodeType && h === d || ce(h) || (h.content instanceof o && _e(h.content), me(h), d = h);
                            if (d = null, qt) return t;
                            if (jt) {
                                if (Ot)
                                    for (c = dt.call(n.ownerDocument); n.firstChild;) c.appendChild(n.firstChild);
                                else c = n;
                                return Rt && (c = ct.call(a, c, !0)), c
                            }
                            var m = Nt ? n.outerHTML : n.innerHTML;
                            return At && (m = g(m, _t, " "), m = g(m, pt, " ")), st && zt ? st.createHTML(m) : m
    ...
    function i(a) {
        ...
        return t[a].call(n.exports, n, n.exports, i), n.exports
    }
    i.n = t => {
    ...
    (() => {
        ...
        const N = (I = 0, C = "_tl_id", function(t) {
        ...
        let Z = (Y = (G = "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ").length, {
            encode: function(t) {
                if ("number" != typeof t || t !== parseInt(t)) throw '"encode" only accepts integers.';
                for (var e = ""; t;) {
                    var i = t % Y;
                    t = Math.floor(t / Y), e = G[i].toString() + e
                }
                return e
            },
            decode: function(t) {
                ...
                for (var e = 0; t;) {
                    var i = G.indexOf(t[0]);
                    if (i < 0) throw '"decode" can\'t find "' + t[0] + '" in the alphabet: "' + G + '"';
                    var a = t.length - 1;
                    e += i * Math.pow(Y, a), t = t.substring(1)
                }
                return e
            }
        });
        ...
        class at {
            ...
            fire(t, e) {
                ...
                for (var i = E({
                        type: t,
                        target: this
                    }, e), a = this._tl_events[t].slice(), s = 0, n = a.length; s < n; s++) a[s].action ? a[s].action.call(a[s].context || this, i) : S(`no action defined for ${t} listener`);
                return this
            }
        }
        ...
        const nt = function() {
            ...
            function k(t, e) {
                var i, a = {};
                return (i = t.match(c)) && (a.rotate = N(i[1], e ? e.rotate : null)), (i = t.match(u)) && (a.scale = N(i[1], e ? e.scale : null)), (i = t.match(m)) && (a.skewx = N(i[1], e ? e.skewx : null), a.skewy = N(i[3], e ? e.skewy : null)), (i = t.match(_)) && (a.translatex = N(i[1], e ? e.translatex : null), a.translatey = N(i[3], e ? e.translatey : null)), a
            }
            ...
            function I(t, e) {
                ...
                for (c && (a = e.left, s = e.top, delete e.right, delete e.bottom, delete e.left, delete e.top), i = n.length; i--;) {
                    if (u[i] = {}, m[i] = {}, _[i] = {}, c) {
                        var y = v(n[i], "left"),
                            b = v(n[i], "top"),
                            w = [N(E(a) ? a(n[i]) : a || 0, parseFloat(y)), N(E(s) ? s(n[i]) : s || 0, parseFloat(b))];
                    ...
                    for (var L in e) {
                        ...
                        var I, C = v(n[i], L),
                            j = E(e[L]) ? e[L](n[i]) : e[L];
                        "string" != typeof j || !l.test(j) || l.test(C) ? (u[i][L] = "transform" == L ? k(C) : "string" == typeof j && l.test(j) ? T(C).slice(1) : parseFloat(C), m[i][L] = "transform" == L ? k(j, u[i][L]) : "string" == typeof j && "#" == j.charAt(0) ? T(j).slice(1) : N(j, parseFloat(C)), "string" == typeof j && (I = j.match(d)) && (_[i][L] = I[1])) : delete e[L]
                    }
                }
                return D.apply(n, [r, function(t, a, s) {
                    for (i = n.length; i--;)
                        for (var o in c && (s = S(p[i], t), n[i].style.left = s[0] + "px", n[i].style.top = s[1] + "px"), e) a = A(t, _, u, m, o, i), "transform" == o ? n[i].style[f] = x(a) : "opacity" != o || g ? n[i].style[M(o)] = a : n[i].style.filter = "alpha(opacity=" + 100 * a + ")"
                }, o, h])
            }
            return y((function(t) {
                o = t > 1e12 != s() > 1e12
            })), I.tween = D, I.getStyle = v, I.bezier = S, I.transform = f, I.parseTransform = k, I.formatTransform = x, I.easings = {}, I
        }();
        class ot {
            show(t) {
        ...
        var lt, ht = {
            ...
            dt = function() {
                ...
                function O(t) {
                    return j(t) && !I(t) && Object.getPrototypeOf(t) == Object.prototype
                }
                ...
                function F(i, a, s) {
                    for (e in a) s && (O(a[e]) || S(a[e])) ? (O(a[e]) && !O(i[e]) && (i[e] = {}), S(a[e]) && !S(i[e]) && (i[e] = []), F(i[e], a[e], s)) : a[e] !== t && (i[e] = a[e])
                }
                ...
                return E.matches = function(t, e) {
                    ...
                    return _.test(e) && (n = i(h.createElement(RegExp.$1))), n || (e.replace && (e = e.replace(p, "<$1></$2>")), a === t && (a = m.test(e) && RegExp.$1), a in w || (a = "*"), (l = w[a]).innerHTML = "" + e, n = i.each(r.call(l.childNodes), (function() {
                        l.removeChild(this)
                    }))), O(s) && (o = i(n), i.each(s, (function(t, e) {
                    ...
                    if ("string" == typeof e)
                        ...
                        if (E.isZ(e)) return e;
                        if (S(e)) n = e, s = l.call(n, (function(t) {
                            return null != t
                        }));
                        else if (j(e)) s = [e], e = null;
                ...
                }, i.type = A, i.isFunction = N, i.isWindow = I, i.isArray = S, i.isPlainObject = O, i.isEmptyObject = function(t) {
                    var e;
                    for (e in t) return !1;
                    return !0
                    ...
                    filter: function(t) {
                        return N(t) ? this.not(this.not(t)) : i(l.call(this, (function(e) {
                    ...
                    not: function(e) {
                        ...
                        if (N(e) && e.call !== t) this.each((function(t) {
                            ...
                            var s = "string" == typeof e ? this.filter(e) : R(e) && N(e.item) ? r.call(e) : i(e);
                    ...
                    has: function(t) {
                        return this.filter((function() {
                            return j(t) ? i.contains(this, t) : i(this).find(t).size()
                        }))
                    },
                    eq: function(t) {
                    ...
                    siblings: function(t) {
                        return $(this.map((function(t, e) {
                            return l.call(q(e.parentNode), (function(t) {
                                return t !== e
                            }))
                        })), t)
                    },
                    ...
                    html: function(t) {
                        return 0 === arguments.length ? this.length > 0 ? this[0].innerHTML : null : this.each((function(e) {
                            ...
                            i(this).empty().append(B(this, t, e, a))
                        }))
                    },
                    text: function(e) {
                    ...
                    attr: function(i, a) {
                        ...
                        return "string" == typeof i && a === t ? 0 == this.length || 1 !== this[0].nodeType ? t : "value" == i && "INPUT" == this[0].nodeName ? this.val() : !(s = this[0].getAttribute(i)) && i in this[0] ? this[0][i] : s : this.each((function(t) {
                            if (1 === this.nodeType)
                                if (j(i))
                                    for (e in i) U(this, e, i[e]);
                                else U(this, i, B(this, a, t, this.getAttribute(i)))
                        }))
                    },
                    ...
                    prop: function(e, i) {
                        return e = D[e] || e, i === t ? this[0] && this[0][e] : this.each((function(t) {
                            this[e] = B(this, i, t, this[e])
                        }))
                    },
                    data: function(e, i) {
                    ...
                    css: function(t, a) {
                        ...
                        var l = "";
                        if ("string" == A(t)) a || 0 === a ? l = z(t) + ":" + H(t, a) : this.each((function() {
                    ...
                    addClass: function(t) {
                        return t ? this.each((function(e) {
                            a = [];
                            var s = W(this);
                            B(this, t, e, s).split(/\s+/g).forEach((function(t) {
                    ...
                    removeClass: function(e) {
                        return this.each((function(i) {
                            ...
                            a = W(this), B(this, e, i, a).split(/\s+/g).forEach((function(t) {
                                a = a.replace(P(t), " ")
                            })), W(this, a.trim())
                        }))
                    },
                    toggleClass: function(e, a) {
                        return e ? this.each((function(s) {
                            var n = i(this);
                            B(this, e, s, W(this)).split(/\s+/g).forEach((function(e) {
                    ...
                    i.fn[t] = function() {
                        var t, s, n = i.map(arguments, (function(e) {
                                return "object" == (t = A(e)) || "array" == t || null == e ? e : E.fragment(e)
                            })),
                            o = this.length > 1;
                ...
                })), E.Z.prototype = i.fn, E.uniq = n, E.deserializeValue = Z, i.zepto = E, i
            }();
        ...
        const ct = dt.getJSON,
            ...
            yt = it.extend({
                ...
                getDisplayDate: function(t, e) {
                    ...
                    t || (t = At.fallback), t.constructor != At && (S("First argument to getDisplayDate must be type Language"), t = At.fallback);
                ...
                _getDateData: function() {
                    ...
                    for (var e in E(t, this.data), pt) {
                        if (!j(t[pt[e]]).match(/^-?\d*$/)) throw new x("invalid_date_err", pt[e] + " = '" + t[pt[e]] + "'");
        ...
        function bt(t) {
            ...
            if (t.match(/\d+\/\d+/) && (s = t.match(/\d+\/\d+/)[0], t = j(t.replace(s, "")), n = s.split("/"), a.month = n[0], a.year = n[1]), t.match(":")) {
                var o = t.split(":");
        ...
        class At {
            ...
            formatBigYear(t, e) {
                ...
                return S("Language file dateformats missing cosmological. Falling back."), It(i, e)
            }
            _(t, e) {
                let i = this.messages[t] || At.fallback.messages[t] || t;
                if (i.match(St)) {
            ...
            formatDate(t, e) {
                return t.constructor == Date ? this.formatJSDate(t, e) : t.constructor == wt ? this.formatBigYear(t, e) : t.data && t.data.date_obj ? this.formatDate(t.data.date_obj, e) : (S("Unfamiliar date presented for formatting"), t.toString())
            }
            formatJSDate(t, e) {
                var i = this,
                    a = function(t, e) {
                ...
                var n = t.getDate(),
                    ...
                    _ = {
                        ...
                        o: (m > 0 ? "-" : "+") + A(100 * Math.floor(Math.abs(m) / 60) + Math.abs(m) % 60, 4),
                        S: ["th", "st", "nd", "rd"][n % 10 > 3 ? 0 : (n % 100 - n % 10 != 10) * n % 10]
                    },
                    p = s.replace(At.DATE_FORMAT_TOKENS, (function(t) {
                        return t in _ ? _[t] : t.slice(1, t.length - 1)
                    }));
                return this._applyEra(p, l)
            }
        ...
        var Ct = {
            en: {
                ...
                dateformats: {
                    year: "yyyy",
                    month_short: "mmm yyyy", // Ensure that the month format includes the year
                    month: "mmmm yyyy", // Include the year in the month format
                    full_short: "mmm d',' yyyy", // Include the year in the short full format
                    full: "mmmm d',' yyyy", // Include the year in the full date format
                    time: "h:MM:ss TT' <small>'mmmm d',' yyyy'</small>'", // Include the year
                    time_short: "h:MM:ss TT",
                    time_no_seconds_short: "h:MM TT",
                    time_no_minutes_short: "h TT",
                    time_no_seconds_small_date: "h:MM TT' <small>'mmmm d',' yyyy'</small>'",
                    time_milliseconds: "l",
                    full_long: "mmm d',' yyyy 'at' h:MM TT", // Include the year
        ...
        function Pt(t) {
            ...
            a && (i = j(a[0]), t = j(t.substring(0, t.lastIndexOf(i))));
            var s = [],
        ...
        function Gt(t) {
            return Bt().sanitize(t, {
                ADD_TAGS: ["iframe"],
                ADD_ATTR: ["frameborder", "target"]
            })
        }
        Bt().addHook("afterSanitizeAttributes", (function(t) {
        ...
        class Yt {
            ...
            logError(t) {
                S(`logError: ${t}`), this.messages.errors.push(t)
            }
            getErrors(t) {
            ...
            addEvent(t, e) {
                ...
                return void 0 === t.start_date ? (S("Missing start date, skipping event"), console.log(t), null) : (this._processDates(t), this._tidyFields(t), this.events.push(t), this.event_dict[i] = t, e || zt(this.events), i)
            }
            addEra(t) {
            ...
            _assignID(t) {
                var e = t.unique_id;
                return j(e) || (e = t.text ? R(t.text.headline) : null), t.unique_id = function(t, e) {
            ...
            _makeUniqueIdentifiers(t, e) {
                for (var i = [t], a = 0; a < e.length; a++) j(e[a].unique_id) && (e[a].unique_id = R(e[a].unique_id), -1 == i.indexOf(e[a].unique_id) ? i.push(e[a].unique_id) : e[a].unique_id = "");
                if (i.length != e.length + 1)
                    for (a = 0; a < e.length; a++)
                        if (!e[a].unique_id) {
                            var s = e[a].text ? R(e[a].text.headline) : null;
            ...
            _ensureValidScale(t) {
                ...
                Ft[this.scale] || this.logError("Don't know how to process dates on scale " + this.scale)
            }
            _processDates(t) {
                var e = Ft[this.scale];
                if (!(t.start_date instanceof e)) {
                    ...
                    if (t.start_date = new e(i), void 0 !== t.end_date && !(t.end_date instanceof e)) {
                        ...
                        s ? (S("End date same as start date is redundant; dropping end date"), delete t.end_date) : t.end_date = new e(a)
                    }
                }
            }
            getEarliestDate() {
            ...
            _tidyFields(t) {
                ...
                t.group && (t.group = j(t.group)), t.text || (t.text = {}), e(t.text, "text"), e(t.text, "headline"), Zt(t, Gt, Ut), Zt(t, J, Wt)
            }
        }
                    ...
                    if (! function(t) {
                        ...
                        let e = function(t) {
                            ...
                            if (Object.keys(e).includes("Start Date") || Object.keys(e).includes("End Date")) e["Start Date"] && (a.start_date = bt(e["Start Date"])), e["End Date"] && (a.end_date = bt(e["End Date"]));
                                ...
                                if (a.start_date && !qt(a.start_date)) throw new x("invalid_date_err");
                                if (a.end_date && !qt(a.end_date)) throw new x("invalid_date_err")
                            }
                            return a
                        }(t);
                        ! function(t, e) {
        ...
        ie("human", _t), ie("cosmological", Lt);
        const ae = {
        ...
        class se {
            ...
            getDateFromTime(t) {
                ...
                if ("cosmological" == this._scale) return new Dt(new wt(t));
            ...
            getAxisTickDateFormat(t) {
                return "cosmological" == this._scale ? "compact" : ae[t]
            }
        }
        class ne {
            constructor(t) {
        ...
        class he {
            ...
            loadMedia() {
                ...
                if (!this._state.loaded) try {
                    ...
                    S("Error loading media for ", this._media), S(t)
                }
            }
            _updateMessage(t) {
        ...
        class _e extends he {
            _loadMedia() {
                ...
                this.youtube_loaded = !1, this._el.content_item = this.domCreate("div", "tl-media-item tl-media-youtube tl-media-shadow", this._el.content), this._el.content_item.id = z(7), t = function(t) {
                    ...
                    return s
                }(this.data.url), this.media_id = {}, this.data.url.match("v=") ? this.media_id.id = t.v : this.data.url.match("/embed/") ? this.media_id.id = this.data.url.split("embed/")[1].split(/[?&]/)[0] : this.data.url.match(/v\/|v=|youtu\.be\//) ? this.media_id.id = this.data.url.split(/v\/|v=|youtu\.be\//)[1].split(/[?&]/)[0] : S("YOUTUBE IN URL BUT NOT A VALID VIDEO"), this.data.url.match("start=") ? this.media_id.start = V(this.data.url.split("start=")[1]) : this.data.url.match("t=") && (this.media_id.start = V(this.data.url.split("t=")[1])), this.data.url.match("end=") && (this.media_id.end = V(this.data.url.split("end=")[1])), this.media_id.hd = Boolean(void 0 !== t.hd), ce("https://www.youtube.com/iframe_api", (function() {
                    e.createMedia()
                }))
            }
            _updateMediaDisplay() {
        ...
        class fe extends he {
            constructor(t, e, i) {
                super(t, e, i), this.blockquote = Bt().sanitize(this.data.url)
            }
            _loadMedia() {
        ...
        class ve extends he {
            _loadMedia() {
                var t, e = this.options.width || 1e3,
            ...
            _getImageURL(t, e) {
                if (t && this.base_image_url) {
                    ...
                    if (e) return this.base_image_url.replace(e[1], `/${t}px-`)
                }
        ...
        class ye extends he {
            _loadMedia() {
                ...
                this._el.content_item = this.domCreate("div", "tl-media-item tl-media-iframe tl-media-soundcloud tl-media-shadow", this._el.content), this.media_id = this.data.url, t = "https://soundcloud.com/oembed?url=" + this.media_id + "&format=js&callback=?", ct(t, (function(t) {
                    ce("https://w.soundcloud.com/player/api.js", (function() {
                        e.createMedia(t)
                    }))
                }))
            }
        ...
        class xe extends he {
            ...
            createMedia(t) {
                var e, i, a, s = "",
                    ...
                    o = "",
                    r = this;
                n = t.html.split("</p>&mdash;")[0] + "</p></blockquote>", e = t.author_url.split("twitter.com/")[1], i = (o = t.html.split("</p>&mdash;")[1].split('<a href="')[1]).split('">')[0], a = o.split('">')[1].split("</a>")[0], (n = n.replace(/<a href/gi, '<a target="_blank" rel="noopener" href')).includes("pic.twitter.com") ? (ce("https://platform.twitter.com/widgets.js", (function() {
        ...
        class Me extends he {
            ...
            establishMediaID() {
                if (this.data.url.match(/flic.kr\/.+/i)) {
                    ...
                    this.media_id = Z.decode(t)
                } else {
                    var e = "flickr.com/photos/",
                        i = this.data.url.indexOf(e);
                    if (-1 == i) throw new x("flickr_invalidurl_err");
                    var a = i + e.length;
                    this.media_id = this.data.url.substr(a).split("/")[1]
                }
            }
            createMedia() {
                var t = this;
        ...
        class Ee extends he {
            _loadMedia() {
                var t = this;
                this._el.content_item = this.domCreate("div", "tl-media-item tl-media-documentcloud tl-media-shadow", this._el.content), this._el.content_item.id = z(7), this.data.url.match(/\.html$/) ? this.data.url = this._transformURL(this.data.url) : this.data.url.match(/.(json|js)$/) || S("DOCUMENT CLOUD IN URL BUT INVALID SUFFIX"), ce(["https://assets.documentcloud.org/viewer/loader.js", "https://assets.documentcloud.org/viewer/viewer.js"], (function() {
                    t.createMedia()
                }))
            }
            _transformURL(t) {
        ...
        const Le = "https://graph.facebook.com/v8.0/instagram_oembed?access_token=704270473831239|830b21071290df4f81a35c56abbea096&fields=html,thumbnail_url,author_name&url=";
        ...
        class Ae extends he {
            ...
            getImageURL() {
                ...
                mt(`${Le}${this.data.url}`).then((t => t.thumbnail_url)).catch((t => {
                    S(`Instagram getImageURL Error: ${t.status} ${t.statusText}`)
                }))
            }
            _getMeta() {
        ...
        class Ce extends he {
            ...
            _updateMediaDisplay(t) {
                var e = this.options.height,
                    i = 0,
                    a = 0;
                e = h ? this.options.height / 2 : this.options.height - this.options.credit_height - this.options.caption_height - 30, this._el.content_item.style.maxHeight = "none", S(e), S(this.options.width), e > this.options.width ? (S("height is greater"), i = this.options.width + 80 + "px", a = this.options.width + "px") : (S("width is greater"), S(this.options.width), i = e + "px", a = e - 80 + "px"), this.player.style.width = a, this.player.style.height = i, this._el.credit && (this._el.credit.style.width = a), this._el.caption && (this._el.caption.style.width = a)
            }
            _stopMedia() {}
        }
        class je extends he {
            constructor(t, e, i) {
                super(t, e, i), this.iframe = Bt().sanitize(this.data.url, {
                    ADD_TAGS: ["iframe"],
        ...
        class Oe extends he {
            _loadMedia() {
                try {
                    ...
                    ce(["https://s.imgur.com/min/embed.js"], (function() {
                        t.createMedia()
                    }))
                } catch (t) {
                ...
                this._el.content_item = this.domCreate("div", "tl-media-item tl-media-image tl-media-imgur", this._el.content), ut({
                    ...
                    success: function(e) {
                        try {
                            ...
                            S("Error processing imgur ajax response")
                        }
                    },
        ...
        class Fe {
            ...
            getFormattedDate() {
                if (j(this.data.display_date).length > 0) return this.data.display_date;
                let t = "";
            ...
            _initLayout() {
                ...
                this._el.text = v("div", "tl-timemarker-text", this._el.content), this._text = v("h2", "tl-headline", this._el.text), this.data.text.headline && "" != this.data.text.headline ? this._text.innerHTML = q(this.data.text.headline) : this.data.text.text && "" != this.data.text.text ? this._text.innerHTML = q(this.data.text.text) : this.data.media && this.data.media.caption && "" != this.data.media.caption && (this._text.innerHTML = q(this.data.media.caption));
        ...
        class Be {
            ...
            _getTimeScale() {
                ...
                try {
                    ...
                    S("Invalid value for marker_height_min option."), t = 30
                }
                return 0 == t && (S("marker_height_min option must not be zero."), t = 30), this.max_rows = Math.round((this.options.height - this._el.timeaxis_background.offsetHeight - this.options.marker_padding) / t), this.max_rows < 1 && (this.max_rows = 1), new se(this.config, {
            ...
            _createEras(t) {
                for (var e = 0; e < t.length; e++) {
                    var i = t[e],
                        a = new oe(i.start_date, i.end_date, i.headline, this.options);
        ...
        class Ue {
            ...
            _initLayout() {
                ...
                this.data.media && this.data.media.url && "" != this.data.media.url && (this.has.media = !0), this.data.text && this.data.text.text && (this.has.text = !0), this.data.text && this.data.text.headline && (this.has.headline = !0), this.has.media && (this.data.media.mediatype = qe(this.data.media), this.options.media_name = this.data.media.mediatype.name, this.options.media_type = this.data.media.mediatype.type, this.options.autolink = this.data.autolink, this._media = new this.data.media.mediatype.cls(this.data.media, this.options, this.getLanguage())), (this.has.text || this.has.headline) && (this._text = new le(this.data.text, {
        ...
        class We {
            ...
            _update(t) {
                ...
                const e = q(this.data.title);
                this._el.title.innerHTML = e;
                const i = q(this.data.date);
                this._el.description.innerHTML = i, this._el.container.setAttribute("aria-label", `${this.options.direction}, ${e}, ${i}`)
            }
            _initLayout() {
                this._el.content_container = v("div", "tl-slidenav-content-container", this._el.container), this._el.icon = v("div", "tl-slidenav-icon", this._el.content_container), this._el.title = v("div", "tl-slidenav-title", this._el.content_container), this._el.description = v("div", "tl-slidenav-description", this._el.content_container), this._el.icon.innerHTML = "&nbsp;", this._update()
            }
            _initEvents() {
                ht.addListener(this._el.container, "click", this._onMouseClick, this)
            }
        ...
        class Ze {
            ...
            _createSlide(t, e, i) {
                var a = new Ue(t, this.options, e, this.getLanguage());
            ...
            _onSlideAdded(t) {
                S("slideadded"), this.fire("slideAdded", this.data)
            }
            _onSlideRemoved(t) {
        ...
        if (document) {
            ...
            t && t.length > 0 && (Ye = t[t.length - 1].src)
        }
        class Ve {
            constructor(t, e, i) {
                if (i || (i = {}), this.ready = !1, this._el = {
                        ...
                        timenav: {},
                        menubar: {}
                    }, i.lang && !i.language && (i.language = i.lang), this.language = jt, this._storyslider = {}, this._timenav = {}, this._menubar = {}, this._loaded = {
                        storyslider: !1,
                        timenav: !1
                    ...
                    a ? i.default_bg_color = a : (delete i.default_bg_color, S("Invalid default background color. Ignoring."))
                }
                var s, n;
                E(this.options, i), this.options.script_path || (this.options.script_path = this.determineScriptPath()), i.soundcite && this.on("ready", (() => {
                    S("Loading Soundcite resources "), ue("https://cdn.knightlab.com/libs/soundcite/latest/css/player.css"), ce("https://cdn.knightlab.com/libs/soundcite/latest/js/soundcite.min.js")
            ...
            _loadStyles() {
                ...
                if (t && ue(t), this.options.theme && (0 == this.options.theme.indexOf("http") || this.options.theme.match(/\.css$/))) e = this.options.theme;
            ...
            _initData(t) {
                "string" == typeof t ? async function(t, e) {
                    let i = null,
                        a = {};
                    if ("function" == typeof e ? i = e : "object" == typeof e && (a = e, i = e.callback, "function" == typeof a.callback && (i = a.callback)), !i) throw new x("Second argument to makeConfig must be either a function or an object which includes a 'callback' property with a 'function' type value");
                    var s, n;
                    if (Kt(t)) {
                        try {
                            ...
                            return s = new Yt, "NetworkError" == t.name ? s.logError(new x("network_err")) : "TLError" == t.name ? s.logError(t) : s.logError(new x("unknown_read_err", t.name)), void i(s)
                        }
                        if (s = new Yt(n), n.errors)
                        ...
                        error: function(t, e, a) {
                            s = new Yt, a = "parsererror" == e ? new x("invalid_url_err") : new x("unknown_read_err", e), s.logError(a), i(s)
                        }
                    })
                }(t, {
                    callback: function(t) {
                ...
                }): Yt == t.constructor ? this.setConfig(t) : this.setConfig(new Yt(t))
            }
            _translateError(t) {
                return t.hasOwnProperty("stack") && S(t.stack), t.message_key ? this._(t.message_key) + (t.detail ? " [" + t.detail + "]" : "") : t
            }
            showMessage(t) {
                this.message ? this.message.updateMessage(t) : (S("No message display available."), S(t))
            }
            determineScriptPath() {
                let t = null;
                if (Ye) t = Ye;
            ...
            _initGoogleAnalytics(t) {
                ce(`https://www.googletagmanager.com/gtag/js?id=${t}`), window.dataLayer = window.dataLayer || [], window.gtag = function() {
